...
fun User.toEntity() = UserEntity(id, login, firstName, lastName, email, phone, flatsId)
fun UserEntity.toModel() = User(id, login, firstName, lastName, email, phone, flatsId)
